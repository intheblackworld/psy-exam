...
const answer_list = [
  ...
  [
    {
      desc: '- 實在無法抉擇，覺得再想想或者找資料會做出更好的決定 🧐',
      value: 'p'
    },
    {
      desc: '- 受不了這種彆扭的狀態，覺得快一點作出決定比較好 😛',
      value: 'j'
    },
  ],
]
...
const type_details = {
  intj: {
    name: '系統建造者',
    desc: 'INTJ是16種人格組合中較稀少的類型，被稱為「系統建造者」，具有特殊的特質組合——想像力和務實性。他們尋求以全新的角度或創新的方法來看待事物，對自己的想法和目標非常投入和堅定。在面對相反的意見時，通常持懷疑的態度。他們是所有性格類型中最獨立的。',
    lead: '臉書創辦人小柏',
  ...
  intp: {
    name: '邏輯學家',
    desc: '喜歡獨自工作，不在意頭銜，屬於安靜、有思想、善於解析的類型。他們傾向獨處，以尋找問題解決的方法。INTP類型適合從事和科學、建築和法律相關的職業，他們接受一個觀念，是因為其優點，而非傳統或權威。該人格類型約占人口的1.8%。',
  ...
  infp: {
    name: '調停者',
    desc: '隨和、通情達理，將精力集中於內在世界，但對現實世界充滿強烈的感情以及倫理道德信念，他們希望尋找一個能符合這些價值觀的外在世界。INFP的人對人和事很忠誠，能迅速發現實現理想的機遇。',
    lead: '哈利波特系列小說作者JK羅琳',
  ...
  enfp: {
    name: '競選者',
    desc: '溫暖熱情、富想像力、處事靈活變通。在他們的生活中，充滿着各種可能性。ENFP的人可以在事件與信息之間快速建立聯繫，然後有自信地行動，這類人的即興創作和語言表達能力很強。',
    lead: '迪士尼創始人華特·迪士尼',
  ...
  isfp: {
    name: '探險家',
    desc: '具有隨和、體貼和關懷他人的人生態度，討人喜歡，自己卻不喜歡辯論或發表意見，但是他們的價值觀對自己很重要。ISFP的人對環境敏感，可以很清楚察覺夥伴在做什麼，但卻寧可讓他人帶領自己。',
  ...
  estp: {
    name: '企業家',
    desc: '積極與身邊的人互動，喜愛社交活動，是親身實踐的學習者。ESTP是所有類型中最擅長影響他人的人格類型。他們的語言實在、行動功利，是優秀的危機處理者。',
      ...
      <div className="content">
        ...
        {/* 答案頁 */}
        {
          ...
          <div className="result">
            ...
            <br />
            <div className="btns">
              <div className="btn-submit blue" onClick={reset}>推薦課程</div>
              <div className="btn-submit purple" onClick={reset}>分享IG</div>
              <div className="btn-submit green" onClick={reset}>複製鏈結</div>
